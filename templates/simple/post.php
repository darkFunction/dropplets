    ...
    <div class="row">
        <div class="one-quarter meta">
            ...
            <ul>
                ...
                <li>Subject: <a href="<?php echo $blog_url.'/categories/'.urlencode(trim($post_category)); ?>"><?php echo $post_category ?></a></li>
                <li></li>
            </ul>
        </div>
        ...
        <div class="three-quarters post">
            ...
            <ul class="actions">
                ...
                <li><a class="button" href="<?php echo $blog_url ?>">All Notes</a></li>
            </ul>
